...
public class MDIncrementalRefreshOrderBook43
{
    ...
    private final MDIncrementalRefreshOrderBook43 parentMessage = this;
    ...
    public MDIncrementalRefreshOrderBook43 wrapForEncode(final DirectBuffer buffer, final int offset)
    {
        this.buffer = buffer;
        this.offset = offset;
    ...
    public MDIncrementalRefreshOrderBook43 wrapForDecode(
    ...
    public MDIncrementalRefreshOrderBook43 transactTime(final long value)
    {
    ...
    public static class NoMDEntries implements Iterable<NoMDEntries>, java.util.Iterator<NoMDEntries>
    {
        ...
        private MDIncrementalRefreshOrderBook43 parentMessage;
        private DirectBuffer buffer;
        ...
        public void wrapForDecode(
            final MDIncrementalRefreshOrderBook43 parentMessage, final DirectBuffer buffer, final int actingVersion)
        {
        ...
        public void wrapForEncode(final MDIncrementalRefreshOrderBook43 parentMessage, final DirectBuffer buffer, final int count)
        {
            this.parentMessage = parentMessage;
            this.buffer = buffer;
