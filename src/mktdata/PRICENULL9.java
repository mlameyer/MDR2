...
public class PRICENULL9
{
    private DirectBuffer buffer;
    private int offset;
    private int actingVersion;

    public PRICENULL9 wrap(final DirectBuffer buffer, final int offset, final int actingVersion)
    {
        this.buffer = buffer;
        this.offset = offset;
    ...
    public PRICENULL9 mantissa(final long value)
    {
