...
public class MDIncrementalRefreshLimitsBanding50
{
    ...
    private final MDIncrementalRefreshLimitsBanding50 parentMessage = this;
    ...
    public MDIncrementalRefreshLimitsBanding50 wrapForEncode(final DirectBuffer buffer, final int offset)
    {
        this.buffer = buffer;
        this.offset = offset;
    ...
    public MDIncrementalRefreshLimitsBanding50 wrapForDecode(
    ...
    public MDIncrementalRefreshLimitsBanding50 transactTime(final long value)
    {
    ...
    public static class NoMDEntries implements Iterable<NoMDEntries>, java.util.Iterator<NoMDEntries>
    {
        ...
        private MDIncrementalRefreshLimitsBanding50 parentMessage;
        private DirectBuffer buffer;
        ...
        public void wrapForDecode(
            final MDIncrementalRefreshLimitsBanding50 parentMessage, final DirectBuffer buffer, final int actingVersion)
        {
        ...
        public void wrapForEncode(final MDIncrementalRefreshLimitsBanding50 parentMessage, final DirectBuffer buffer, final int count)
        {
            this.parentMessage = parentMessage;
            this.buffer = buffer;
