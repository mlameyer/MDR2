...
public class SnapshotFullRefreshOrderBook53
{
    ...
    private final SnapshotFullRefreshOrderBook53 parentMessage = this;
    ...
    public SnapshotFullRefreshOrderBook53 wrapForEncode(final DirectBuffer buffer, final int offset)
    {
        this.buffer = buffer;
        this.offset = offset;
    ...
    public SnapshotFullRefreshOrderBook53 wrapForDecode(
    ...
    public SnapshotFullRefreshOrderBook53 lastMsgSeqNumProcessed(final long value)
    {
    ...
    public SnapshotFullRefreshOrderBook53 totNumReports(final long value)
    {
    ...
    public SnapshotFullRefreshOrderBook53 securityID(final int value)
    {
    ...
    public SnapshotFullRefreshOrderBook53 noChunks(final long value)
    {
    ...
    public SnapshotFullRefreshOrderBook53 currentChunk(final long value)
    {
    ...
    public SnapshotFullRefreshOrderBook53 transactTime(final long value)
    {
    ...
    public static class NoMDEntries implements Iterable<NoMDEntries>, java.util.Iterator<NoMDEntries>
    {
        ...
        private SnapshotFullRefreshOrderBook53 parentMessage;
        private DirectBuffer buffer;
        ...
        public void wrapForDecode(
            final SnapshotFullRefreshOrderBook53 parentMessage, final DirectBuffer buffer, final int actingVersion)
        {
        ...
        public void wrapForEncode(final SnapshotFullRefreshOrderBook53 parentMessage, final DirectBuffer buffer, final int count)
        {
            this.parentMessage = parentMessage;
            this.buffer = buffer;
