...
public class Decimal9NULL
{
    private DirectBuffer buffer;
    private int offset;
    private int actingVersion;

    public Decimal9NULL wrap(final DirectBuffer buffer, final int offset, final int actingVersion)
    {
        this.buffer = buffer;
        this.offset = offset;
    ...
    public Decimal9NULL mantissa(final long value)
    {
